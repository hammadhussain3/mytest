        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
                ...
                <form class="row g-3" method="POST" action="{{route('update_category')}}" enctype="multipart/form-data">
			          @csrf
              ...
              <div class=" mt-3">
                  <div class="col-md-12" style="text-align: right;">
                    <button type="button" class="btn btn-primary submit" id="formsumittButton">Update</button>
                  </div>
                </div>  
              </form>
